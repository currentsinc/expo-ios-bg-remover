...
internal class IOSVersionNotSupported: Exception {
  override var reason: String {
    "iOS version must be 17.0 or higher"
  }
}
...
internal class BackgroundRemoveFailedException: GenericException<String> {
  override var reason: String {
    "Removing the background failed: \(param)"
  }
}